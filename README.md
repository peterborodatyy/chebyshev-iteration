...
An interactive [Go notebook](notebooks/chebyshev_iteration.ipynb) (requires [gophernotes](https://github.com/gopherdata/gophernotes)) with charts generated by `gonum/plot`:
